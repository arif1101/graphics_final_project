...
void cubeMan() {
    // Head
    glPushMatrix();
    glTranslatef(0.25, 14, 0); // Position the head above the body
    glScalef(1.5, 1.5, 1.5);     // Head size
    cube(1.0f, 0.8f, 0.6f);  // Skin color
    glPopMatrix();

    // Body
    glPushMatrix();
    glTranslatef(-1, 7, 0); // Position the body under the head
    glScalef(2.5, 3.5, 0.8); // Body dimensions
    cube(1.000, 0.271, 0.000);  // Blue color
    glPopMatrix();

    // Right Arm
    glPushMatrix();
    glTranslatef(-3, 8, 0); // Position left arm beside the body
    glScalef(1, 2, 0.5);     // Arm dimensions
    cube(1.0f, 0.8f, 0.6f);      // Skin color
    glPopMatrix();

    // left Arm
    glPushMatrix();
    glTranslatef(4, 8, 0); // Position left arm beside the body
    glScalef(1, 2, 0.5);     // Arm dimensions
    cube(1.0f, 0.8f, 0.6f);      // Skin color
    glPopMatrix();
    ...
    // Left Leg
    glPushMatrix();
    glTranslatef(-0.75, -1, 0);  // Position left leg below the body
    glScalef(1, 4, 0.5);      // Leg dimensions
    cube(0.0f, 0.0f, 0.0f);      // Black color
    glPopMatrix();

    // Right Leg
    glPushMatrix();
    glTranslatef(2, -1, 0);   // Position right leg below the body
    glScalef(1, 4, 0.5);      // Leg dimensions
    cube(0.0f, 0.0f, 0.0f);      // Black color
    glPopMatrix();
}
void student() {
    // Head
    glPushMatrix();
    glTranslatef(0.25, 8, 0); // Position the head above the body
    glScalef(0.5, 0.5, 0.5);     // Head size
    cube(1.0f, 0.8f, 0.6f);  // Skin color
    glPopMatrix();

    // Body
    glPushMatrix();
    glTranslatef(-1, 3, 0); // Position the body under the head
    glScalef(1.5, 2.5, 0.8); // Body dimensions
    cube(0.0f, 0.0f, 1.0f);  // Blue color
    glPopMatrix();

    // Right Arm
    glPushMatrix();
    glTranslatef(-2, 4, 0); // Position left arm beside the body
    glScalef(0.5, 1.5, 0.5);     // Arm dimensions
    cube(1.0f, 0.8f, 0.6f);      // Skin color
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef(2, 4, 0); // Position left arm beside the body
    glScalef(.5, 1.5, 0.5);     // Arm dimensions
    cube(1.0f, 0.8f, 0.6f);      // Skin color
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef(-0.75, -1, 0);  // Position left leg below the body
    glScalef(0.5, 2, 0.5);      // Leg dimensions
    cube(0.0f, 0.0f, 0.0f);      // Black color
    glPopMatrix();

    // Right Leg
    glPushMatrix();
    glTranslatef(0.75, -1, 0);   // Position right leg below the body
    glScalef(0.5, 2, 0.5);      // Leg dimensions
    cube(0.0f, 0.0f, 0.0f);      // Black color
    glPopMatrix();
}
...
void full_set()
{
    ...
    // Add student (cubeMan)
    glPushMatrix();
    glTranslatef(-0.5, -4.5, -6); // Adjust position to place the student
    student();
    glPopMatrix();
}
...
void room()
{
    ...
    glRotatef(90,1,0,0);
    wall(0.878, 1.000, 1.000); //back  wall
    glPopMatrix();
...
// Add a simple cube man
    glPushMatrix();
    glTranslatef(-17, 0, 30); // Position the man in the classroom
    cubeMan();
    glPopMatrix();
